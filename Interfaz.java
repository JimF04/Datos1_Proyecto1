...
public class Interfaz {
    ...
    public Interfaz() {
        ...
        areadetexto.setBounds(20, 300, 300, 300);
        areadetexto.setEditable(false);
        milamina.add(areadetexto);
    ...
    class Ventana3 extends JFrame {
        ...
        public Ventana3() {
            ...
            JButton returnbtni = new JButton("RETURN");
            ...
            for (Linea linea1 : adyacentes) {
                for (Linea linea2 : obtenerAdyacentes(linea1)) {
                    for (Linea linea3 : obtenerAdyacentes(linea2)) {
                        ...
                        if (linea1.equals(nuevaLinea) || linea1.equals(nuevaLinea) || linea2.equals(nuevaLinea)
                        || linea3.equals(nuevaLinea) || linea1.equals(linea2) || linea1.equals(linea3)
                        || linea2.equals(linea3)) {
                    continue;
                }
            ...
            if (puntoseleccionado != null) {
                ...
                if (puntosSeleccionados.size() == 2) {
                    ...
                    if (esLineaValida(p1, p2)) {
                        ...
                        System.out.println(
                                "Solo se pueden hacer líneas verticales, horizontales y con un espacio de 100 entre puntos");
                    }
...
// Resto de la clase Interfaz
// ...

// Resto de las clases Punto, Linea, Nodo, y ListaEnlazada
// ...
}
